...
# full version
ggsave(filename = "outputs/submarine-cable-map-fs.svg", plot = v1, width=1280/72, height=720/72)

# thumbnail version without annotations
ggsave(filename = "outputs/submarine-cable-map-sm.png", plot = v1, width=4, height=2.25)
