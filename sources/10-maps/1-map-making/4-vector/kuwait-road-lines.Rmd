...
```{r, out.width = "60%", fig.align = 'center', fig.cap="Photo by Hamed Alayoub on Unsplash"}

masthead <- "assets/hamed-alayoub-unsplash.jpg"
knitr::include_graphics(masthead, dpi=72)

```

<div class="figure-text">Jahra, Kuwait</div>
...
ggsave(filename = "outputs/kuwait-road-line-map-sm.svg", plot = v2, width=16, height=14)
