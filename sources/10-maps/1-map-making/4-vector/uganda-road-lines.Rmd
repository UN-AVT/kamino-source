...
```{r, out.width = "60%", fig.align = 'center', fig.cap="Photo by Melissa Askew on Unsplash"}

masthead <- "assets/melissa-askew-unsplash.jpg"
...
Administrative boundaries at levels __adm0__, __adm1__, __adm2__, and __road__ lines
...
### Plot the road lines within the base-vector map
#### Use geom_sf on the road-lines data


```{r, message=FALSE, warning=FALSE, echo=TRUE, class.source = 'fold-hide', out.width = "100%"}

v2 <- v1 + geom_sf( data = df_road_lines, color = "#c77307", size = 0.5 )
...
ggsave(filename = "outputs/uganda-road-line-map-fs.svg", plot = v2, width=16, height=9)
