...
xyz_df <- read.csv("../archetypes/south-america.csv", header = TRUE)
xyz_df

xyz_df_zero <- read.csv("../archetypes/south-america.csv", header = TRUE)
xyz_df_zero
...
v1 <- ggplot(xyz_df, aes(a, b, height = c, group = b)) + 
...
xyz_df_zero$npop <- range01(xyz_df_zero$c) * 0.2
xyz_df_zero$ny<-range01(xyz_df_zero$b)
xyz_df_zero$nx<-range01(xyz_df_zero$a)
...
#ggsave(filename = "south-america-ridgeline-xyz-v1.svg", plot = v1, width=12, height=6)
#ggsave(filename = "south-america-ridgeline-xyz-v2.svg", plot = v2, width=12, height=6)
