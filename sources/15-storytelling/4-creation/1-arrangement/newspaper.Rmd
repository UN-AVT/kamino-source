...
```{r, message=FALSE, warning=FALSE, echo=TRUE, class.source = 'fold-hide', fig.width=10.5, fig.height=4, out.width = "90%" }
...
```{r, message=FALSE, warning=FALSE, echo=TRUE, class.source = 'fold-hide', fig.width=10.5, fig.height=5, out.width = "90%" }
...
ggplot(mpg, aes(x = class)) + theme_tufte(base_size=14, ticks=F) +
