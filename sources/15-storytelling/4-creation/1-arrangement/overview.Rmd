...
The output and differences between format and media.

Analysis products are often presented as reports, briefs, and articles in print or web form.

As such, showing continuity of images relies on still panels for physical support.  To create the illusion of movement.

However, there are many creative opportunities such as panel size, shape,
