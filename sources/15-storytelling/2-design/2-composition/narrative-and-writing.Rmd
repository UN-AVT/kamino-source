...
Narrative questions drive the story. The questions are arranged in a hierarchy,
meaning that some are more important than others. Some smaller questions will
need to be answered before the bigger ones can be answered.

Meaning is constructed from clues provided in the film that we put together
in order to answer the narrative questions.


### Types of Narrative Questions
#### with custom styling

Let’s look at some of the different types of narrative questions that we can use
to structure our stories. The most common type is the goal outcome question.
Will the characters achieve their goal?
