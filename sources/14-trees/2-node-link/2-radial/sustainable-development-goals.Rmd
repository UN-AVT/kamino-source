...
```{r, out.width = "60%", fig.align = 'center', fig.cap="Photo by Alex Radelich on Unsplash"}

masthead <- "assets/alex-radelich-unsplash.jpg"
...
### Ingest
#### nodes and edges representing the structure


```{r, message=FALSE, warning=FALSE, echo=TRUE, class.source = 'fold-hide'}

# Tree data
df_edges_path <- "archetypes/sustainable-development-goals/sustainable-development-goals-edges.csv"
df_edges <- read.csv(df_edges_path, header = TRUE, stringsAsFactors = FALSE)
df_edges

df_nodes_path <- "archetypes/sustainable-development-goals/sustainable-development-goals-nodes.csv"
...
df_graph_directed <- graph_from_data_frame( df_edges, vertices=df_nodes, directed = TRUE )
df_graph_undirected <- graph_from_data_frame( df_edges, vertices=df_nodes, directed = FALSE )
...
v1 <- ggraph(df_graph, layout = dendrogram) + 
  ...
  geom_node_label( aes(label=name), repel = FALSE, vjust = 0.0, nudge_y = 0.1, size = 3, family = "inconsolata") +
