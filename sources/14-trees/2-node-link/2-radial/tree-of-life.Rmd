---
pagetitle: "World, regions, and countries"
output:
  html_document:
    theme: lumen
...
```{r, out.width = "60%", fig.align = 'center', fig.cap="Photo by Louis Hansel on Unsplash"}

masthead <- "assets/louis-hansel-unsplash.jpg"
