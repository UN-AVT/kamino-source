...
```{r, out.width="60%", fig.align="center", fig.cap="Photo by David Thielen on Unsplash"}

masthead <- "assets/david-thielen-unsplash.jpg"
...
df_ingest <- read.csv("archetypes/wind-turbines/wind-turbines.csv", header = TRUE)
df_ingest
