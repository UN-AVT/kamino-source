...
```{r, out.width="60%", fig.align="center", fig.cap="Photo by Monika Grabkowska on Unsplash"}

masthead <- "assets/monika-grabkowska-unsplash.jpg"
...
df_ingest <- read.csv("archetypes/tree-trunks/sf-trees.csv", header = TRUE)
df_ingest
