---
pagetitle: "Mobile phone usage in Colombia"
output: 
  html_document:
    theme: lumen
...
# Mobile phone usage in Colombia
# infographic

```{r, out.width="60%", fig.align="center", fig.cap="Photo by Jorge Gardner on Unsplash"}

masthead <- "assets/jorge-gardner-unsplash.jpg"
...
df <- read.csv("archetypes/mobile-phone-usage/mobile-phone-usage.csv", header = TRUE)
head(df, n=10)
...
df_wrangle <- df %>% filter(entity == "Colombia")
df_wrangle
