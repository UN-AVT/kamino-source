...
masthead <- "assets/china-aircraft-carrier.jpg"
...
```{r, message=FALSE, warning=FALSE, echo=TRUE, fig.align='center', out.width="100%", class.source='fold-hide'}
...
isotype_plot = istack(df, 
 ...
 girafe(ggobj = isotype_plot, width_svg = 16.0, height_svg = 9.0,
