...
# full version
ggsave(filename = "outputs/full-size.svg", plot = v1, width=1280/72, height=720/72)

# thumbnail version without annotations
ggsave(filename = "outputs/thumbnail.png", plot = v1, width=4, height=2.25)
...
* Narrative sources: The Narrative Source, [GO](https://github.com/UN-AVT/kamino-source){target="_blank"}
* Data sources: The Data Source, [GO](https://github.com/UN-AVT/kamino-source){target="_blank"}
