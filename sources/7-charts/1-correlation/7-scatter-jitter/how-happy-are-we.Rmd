...
# full version
ggsave(filename = "assets/citation-rates-for-speeding-stops-fs.svg", plot = v3, width=1280/72, height=720/72)

# thumbnail version without annotations
ggsave(filename = "assets/citation-rates-for-speeding-stops-sm.png", plot = v3, width=4, height=2.25)
