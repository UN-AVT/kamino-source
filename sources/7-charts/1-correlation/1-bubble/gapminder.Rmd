...
gapminder <- read.csv(gapminder_file_path, header = TRUE, stringsAsFactors = FALSE)
gapminder
...
# full version
ggsave(filename = "assets/gapminder-fs.svg", plot = v6, width=1280/72, height=720/72)

# without annotations
ggsave(filename = "assets/gapminder-sm.png", plot = v4, width=4, height=2.25)
