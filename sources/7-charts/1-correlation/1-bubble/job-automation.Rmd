...
# full version
ggsave(filename = "assets/job-automation-fs.svg", plot = v1, width=1280/72, height=720/72)

# thumbnail version without annotations
ggsave(filename = "assets/job-automation-sm.png", plot = v1, width=4, height=2.25)
