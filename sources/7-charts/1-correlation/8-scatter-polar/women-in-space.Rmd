...
df <- read.csv("archetypes/women-in-space/astronaut-data.csv", header = TRUE, stringsAsFactors = FALSE, encoding = "UTF-8")
df
...
girafe(ggobj = v2, width_svg = 1080/72, height_svg = 720/72,
       options = list(opts_sizing(rescale = TRUE, width = 0.9))
)
...
# full version
ggsave(filename = "assets/women-in-space-fs.svg", plot = v1, width=1720/72, height=720/72)

# thumbnail version without annotations
ggsave(filename = "assets/women-in-space-sm.png", plot = v1, width=2.25, height=2.25)
