...
df = read.csv("archetypes/family-integration-policy-by-country/family-integration-policy-by-country.csv", header = TRUE, stringsAsFactors = TRUE)
df
...
```{r drawa, message=FALSE, warning=FALSE, echo=TRUE, class.source = 'fold-hide', out.width="100%"}
...
# full version
ggsave(filename = "assets/family-integration-policy-by-country-fs.svg", plot = v2, width=1280/72, height=720/72)

# thumbnail version without annotations
ggsave(filename = "assets/family-integration-policy-by-country-sm.png", plot = v2, width=4, height=2.25)
