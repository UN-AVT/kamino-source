...
```{r, out.width="60%", fig.align="center", fig.cap="Photo by Kaja Reichardt on Unsplash"}

masthead <- "assets/kaja-reichardt-WB1m8zefmEQ-unsplash.jpg"
...
This case study aims to reproduce a graph from <a href = "https://www.economist.com/graphic-detail/2021/05/06/global-herd-immunity-is-still-out-of-reach">this article</a> published on May 6th 2021 in the Economist.
...
# Load csv data file
df <- read_csv("archetypes/covid-19-vaccination_survey.csv")
df
...
v1 <- ggplot(df_final,aes(x=region_factor, y=percent_yes)) +
  geom_point(aes(size=population), shape=21, color = "#6983AE", alpha = 5/10, fill = "#AFCDDD", stroke = 3) +
...
# full version
ggsave(filename = "assets/global-herd-immunity-fs.svg", plot = v1, width=1280/72, height=720/72)

# thumbnail version without annotations
ggsave(filename = "assets/global-herd-immunity-sm.png", plot = v1, width=4, height=2.25)
