...
df <- read_csv("archetypes/co2-emission-and-gdp-growth/co2-emissions-vs-gdp.csv")
df
...
# full version
#ggsave(filename = "assets/expensive-weddings-fs.svg", plot = v1, width=1280/72, height=720/72)

# thumbnail version without annotations
#ggsave(filename = "outputs/expensive-weddings-sm.svg", plot = v1, width=2.25, height=2.25)
...
* Data sources: Our World in data - CO₂ emissions per capita vs GDP per capita, 2010 to 2018, [GO](https://ourworldindata.org/grapher/co2-emissions-vs-gdp?time=2010..2018){target="_blank"}
