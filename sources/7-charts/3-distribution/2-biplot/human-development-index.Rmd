...
```{r, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, class.source='fold-hide', fig.width=16, fig.height=9, out.width="100%"}
...
# full version
ggsave(filename = "assets/human-development-index-fs.svg", plot = v2, width=1280/72, height=720/72)

# thumbnail version without annotations
ggsave(filename = "assets/human-development-index-sm.png", plot = v2, width=4, height=2.25)
