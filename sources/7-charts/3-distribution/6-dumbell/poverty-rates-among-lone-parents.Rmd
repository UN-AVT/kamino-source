...
# full version
ggsave(filename = "assets/worlds-women-report-fs.svg", plot = v1, width=1280/72, height=720/72)

# thumbnail version without annotations
ggsave(filename = "outputs/worlds-women-report-sm.svg", plot = v1, width=2.25, height=2.25)
