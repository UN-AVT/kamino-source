...
df = read.csv("archetypes/fastest-growing-brands/fastest-growing-brands.csv", header = TRUE, stringsAsFactors = FALSE) # read text file
df
...
# full version
ggsave(filename = "assets/fastest-growing-brands-fs.svg", plot = v1, width=1280/72, height=720/72)

# thumbnail version without annotations
ggsave(filename = "outputs/fastest-growing-brands-sm.svg", plot = v1, width=2.25, height=2.25)
...
* Narrative and Data: Visual Capitalist, Ranked: The World’s Fastest Growing Brands, 2021,
