...
df = read.csv("archetypes/industry-by-gender/industry-by-gender.csv", header = TRUE, stringsAsFactors = TRUE)
df
...
girafe(ggobj = v2, width_svg = 1080/72, height_svg = 1280/72,
       options = list(opts_sizing(rescale = FALSE, width = 1.0)))
...
# full version
ggsave(filename = "outputs/industry-by-gender-fs.svg", plot = v1, width=720/72, height=720/72)

# thumbnail version without annotations
ggsave(filename = "outputs/industry-by-gender-sm.svg", plot = v1, width=2.25, height=2.25)
