...
# full version
ggsave(filename = "assets/food_consumption-by-co2-emissions-fs.svg", plot = v2, width=1280/72, height=720/72)

# thumbnail version without annotations
ggsave(filename = "assets/food_consumption-by-co2-emissions-sm.png", plot = v2, width=4, height=2.25)
