...
# full version
ggsave(filename = "outputs/world-cuisine-preferences-fs.svg", plot = v1, width=1280/72, height=720/72)
...
* Narrative: The Economist, Which countries dominate the world’s dinner tables?, https://www.economist.com/graphic-detail/2019/08/23/which-countries-dominate-the-worlds-dinner-tables
* Data: Journal of Cultural Economics, Dining out as cultural trade
...
keywords <- 'cuisine diet fast food'
commands <- 'gsub ifelse geom_vline'
sources <- 'Economist Journal of Cultural Economics'
