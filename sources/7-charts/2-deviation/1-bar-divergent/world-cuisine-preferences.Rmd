...
url_file1 <- "world-cuisine-preferences/table-6-cuisine-net-exports-excluding-fast-food.csv"
url1 <- paste0(url_root, url_file1)
df_exports <- read.csv(url1, header = TRUE, stringsAsFactors = FALSE)
df_exports

url_file2 <- "world-cuisine-preferences/table-6-cuisine-net-exports-including-fast-food.csv"
url2 <- paste0(url_root, url_file2)
df_fast_food <- read.csv(url2, header = TRUE, stringsAsFactors = FALSE)
df_fast_food
