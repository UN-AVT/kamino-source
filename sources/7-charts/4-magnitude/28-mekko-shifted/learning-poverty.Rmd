...
```{r, echo=TRUE, fig.width=12, fig.height=8, out.width = "95%", class.source = 'fold-hide'}
...
# full version
ggsave(filename = "assets/learning-poverty-fs.svg", plot = v1, width=1280/72, height=720/72)

# thumbnail version without annotations
ggsave(filename = "assets/learning-poverty-sm.png", plot = v1, width=4, height=2.25)
