...
df = read.csv("archetypes/child-marriage/child-marriage.csv", header = TRUE, stringsAsFactors = TRUE)
...
```{r draw-plot, message=FALSE, warning=FALSE, echo=TRUE, class.source='fold-hide', fig.width=15, fig.height=30}
...
# Print the plot
girafe(ggobj = v1, width_svg = 15, height_svg = 30,
...
# full version
ggsave(filename = "assets/child-marriage-fs.svg", plot = v1, width=1280/72, height=720/72)

# thumbnail version without annotations
ggsave(filename = "assets/child-marriage-sm.png", plot = v1, width=4, height=2.25)
