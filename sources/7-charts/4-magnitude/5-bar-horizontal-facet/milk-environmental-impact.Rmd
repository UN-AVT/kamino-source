...
# Load data
df = read.csv("archetypes/milk-environmental-impact/milk-environmental-impacts.csv", header = TRUE, stringsAsFactors = TRUE)
df
...
```{r, message=FALSE, warning=FALSE, echo=TRUE, class.source = 'fold-hide', fig.width = 1920/72, fig.height = 540/72, out.width = "100%"}
...
girafe(ggobj = v1, width_svg = 1280/72, height_svg = 420/72,
...
# full version
ggsave(filename = "assets/milk-environmental-impact-fs.svg", plot = v1, width=1280/72, height=720/72)

# thumbnail version without annotations
ggsave(filename = "assets/milk-environmental-impact-sm.png", plot = v1, width=4, height=2.25)
