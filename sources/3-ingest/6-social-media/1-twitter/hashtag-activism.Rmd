...
masthead <- "assets/brett-jordan-JD0D-lReHFE-unsplash.jpg"
knitr::include_graphics(masthead, dpi=72)

```

<div class="figure-text">Be The Change</div>
...
```{r, out.width="60%", fig.align="center", fig.cap="Boda Boda"}
...
<div class="figure-text">Boda Boda</div>
...
# References
## The citations and data sources used for this case are retrieved from various tweets on Twitter.
...
methods <- "ingest-tweet twitter-api" # mostly used in wranglers and analytics
keywords <- 'activism hashtag traffic-accidents'
commands <- 'create_token search_tweets'
sources <- 'Twitter'
