---
pagetitle: "Ghana's state of the nation addresses"
output: 
  html_document:
    theme: lumen
...
url_file <- "ghana-state-of-the-nation-addresses/sona_2008.txt"
...
To illustrate the methods, this case contains several text files for Ghana's state of the nation addresses. The state of the nation address is an annual address to parliament given by the president. It typically summarizes the government's agenda and the progress made in the past year as seen by the administration in power. [GO](https://home.gis.gov.gh/2021/03/12/state-of-the-nation-address-sona-2021/){target="_blank"}
