...
```{r, out.width = "60%", fig.align = 'center', fig.cap="Masrur Rahman on Unsplash"}

masthead <- "assets/masrur-rahman-unsplash.jpg"
...
ggsave(filename = "assets/kuwait_emirs.svg", plot = v1, width=16, height=9)
ggsave(filename = "assets/kuwait_speakers.svg", plot = v2, width=16, height=9)
