---
pagetitle: "World University Ranking"
output:
  html_document:
    theme: lumen
...
```{r, out.width = "60%", fig.align = 'center', fig.cap="Photo by Emily Karakis on Unsplash"}

masthead <- "assets/emily-karakis-unsplash.jpg"
...
rank_df = read.csv("archetypes/world-university-ranking/times-higher-education-world-university-ranking.csv", header = TRUE, stringsAsFactors = TRUE)  # read text file 
rank_df
...
v1 <- ggplot(data = rank_df, aes(x = year, y = world_rank, group = institution)) +
...
girafe(ggobj = v1, width_svg = 13.0, height_svg = 13.0,
...
ggsave(filename = "assets/times-higher-education-world-university-ranking.svg", plot = v1, width=13.33, height=13.33)
...
* Narrative and Data Sources: Times Higher Education, [GO](https://www.timeshighereducation.com/world-university-rankings){target="_blank"}
