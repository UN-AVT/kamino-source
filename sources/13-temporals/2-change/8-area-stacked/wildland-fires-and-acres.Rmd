...
knitr::include_graphics("assets/pawel-czerwinski-unsplash.jpg", dpi=72)
...
# full version
ggsave(filename = "assets/swedish-trash-fs.svg", plot = v2, width=1280/72, height=720/72)

# without annotations
ggsave(filename = "assets/swedish-trash-sm.svg", plot = v1, width=4, height=2.25)
