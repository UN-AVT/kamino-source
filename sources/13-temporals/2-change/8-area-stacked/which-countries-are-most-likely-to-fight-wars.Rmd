...
Combat deaths per 100,000 people worldwide, conflict timeline

```{r, message=FALSE, warning=FALSE, echo=TRUE, class.source = 'fold-hide'}

# Load csv data file
df <- read.csv("archetypes/which-countries-are-most-likely-to-fight-wars/conflict_years_df_region_aggregated.csv", header = TRUE, stringsAsFactors = FALSE)
df

df_timeline <- read.csv("archetypes/which-countries-are-most-likely-to-fight-wars/conflict_timeline_of_battle_deaths.csv", header = TRUE, stringsAsFactors = FALSE)
df_timeline
...
# full version
ggsave(filename = "assets/which-countries-are-most-likely-to-fight-wars-fs.svg", plot = v3, width=1280/72, height=720/72)

# without annotations
ggsave(filename = "assets/which-countries-are-most-likely-to-fight-wars-sm.png", plot = v3, width=4, height=2.25)
