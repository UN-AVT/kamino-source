---
pagetitle: "Case: How cheap are Electric Cars"
output: 
  html_document:
    theme: lumen
...
# Case: How cheap are Electric Cars
## Normalize
...
methods <- "Normalize" # mostly used in wranglers and analytics
keywords <- 'Electric-cars cars'
commands <- 'scale'
