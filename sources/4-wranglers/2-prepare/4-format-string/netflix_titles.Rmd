...
#NOT TO BE USED AS SOLUTION
df_tmp <- df_1
names(df_tmp)[2] <- cell_spec(names(df_tmp)[2], color = "#01DF01")

df_tmp%>%
kable(escape = FALSE)%>%
kable_styling(position = "center", full_width = FALSE,  bootstrap_options = c("striped", "hover"))%>%
column_spec(2, bold = TRUE, color = "#000000", background = "#CEF6CE")%>%
scroll_box(height = "350px", width = "NULL", extra_css = NULL, fixed_thead = TRUE)
...
#NOT TO BE USED AS SOLUTION
df_tmp <- df_4
names(df_tmp)[11] <- cell_spec(names(df_tmp)[11], color = "#0080FF")

df_tmp%>%
kable(escape = FALSE)%>%
kable_styling(position = "center", full_width = FALSE,  bootstrap_options = c("striped", "hover"))%>%
column_spec(11, bold = TRUE, color = "#000000", background = "#CEECF5")%>%
scroll_box(height = "350px", width = "NULL", extra_css = NULL, fixed_thead = TRUE)
...
#NOT TO BE USED AS SOLUTION
df_tmp <- df_2
names(df_tmp)[12] <- cell_spec(names(df_tmp)[12], color = "#01DF01")


df_tmp%>%
kable(escape = FALSE)%>%
kable_styling(position = "center", full_width = FALSE,  bootstrap_options = c("striped", "hover"))%>%
column_spec(12, bold = TRUE, color = "#000000", background = "#CEF6D8")%>%
scroll_box(height = "350px", width = "NULL", extra_css = NULL, fixed_thead = TRUE)
...
kable(escape = FALSE)%>%
kable_styling(position = "center", full_width = FALSE,  bootstrap_options = c("striped", "hover"))%>%
column_spec(3, bold = TRUE, color = "#000000", background = "#F6E3CE")%>%
scroll_box(height = "350px", width = "NULL", extra_css = NULL, fixed_thead = TRUE)
...
#NOT TO BE USED AS SOLUTION
df_tmp <- df_5
names(df_tmp)[13] <- cell_spec(names(df_tmp)[13], color = "#01DF01")


df_tmp%>%
kable(escape = FALSE)%>%
kable_styling(position = "center",  full_width = FALSE, bootstrap_options = c("striped", "hover"))%>%
column_spec(13, bold = TRUE, color = "#000000", background = "#CEF6D8")%>%
scroll_box(height = "350px", width = "NULL", extra_css = NULL, fixed_thead = TRUE)
...
kable(escape = FALSE)%>%
kable_styling(position = "center", full_width = FALSE, bootstrap_options = c("striped", "hover"))%>%
column_spec(13:15, bold = TRUE, color = "#000000", background = "#CEE3F6")%>%
column_spec(11, bold = TRUE, background = "#A9D0F5")%>%
scroll_box(height = "350px", width = "NULL", extra_css = NULL, fixed_thead = TRUE)
...
#NOT TO BE USED AS SOLUTION
df_tmp <- df_7
names(df_tmp)[13] <- cell_spec(names(df_tmp)[13], color = "#0080FF")


df_tmp%>%
kable(escape = FALSE)%>%
kable_styling(position = "center", full_width = FALSE,  bootstrap_options = c("striped", "hover"))%>%
column_spec(13, bold = TRUE, background = "#A9D0F5")%>%
scroll_box(height = "350px", width = "NULL", extra_css = NULL, fixed_thead = TRUE)
...
#NOT TO BE USED AS SOLUTION
df_tmp <- df_11
names(df_tmp)[1] <- cell_spec(names(df_tmp)[1], color = "#9A2EFE")

df_tmp%>%
kable(escape = FALSE)%>%
kable_styling(position = "center", full_width = FALSE,  bootstrap_options = c("striped", "hover"))%>%
column_spec(1, bold = TRUE, color = "#000000", background = "#D8CEF6")%>%
scroll_box(height = "350px", width = "NULL", extra_css = NULL, fixed_thead = TRUE)
...
#NOT TO BE USED AS SOLUTION
df_tmp <- df_8
names(df_tmp)[4] <- cell_spec(names(df_tmp)[4], color = "#FE9A2E")

df_tmp%>%
kable(escape = FALSE)%>%
kable_styling(position = "center", full_width = FALSE,  bootstrap_options = c("striped", "hover"))%>%
column_spec(4, bold = TRUE, color = "#000000", background = "#F6E3CE")%>%
scroll_box(height = "350px", width = "NULL", extra_css = NULL, fixed_thead = TRUE)
...
#NOT TO BE USED AS SOLUTION
df_tmp <- df_9
names(df_tmp)[5] <- cell_spec(names(df_tmp)[5], color = "#01DF01")

df_tmp%>%
kable(escape = FALSE)%>%
kable_styling(position = "center", full_width = FALSE,  bootstrap_options = c("striped", "hover"))%>%
column_spec(5, bold = TRUE, color = "#000000", background = "#CEF6D8")%>%
scroll_box(height = "350px", width = "NULL", extra_css = NULL, fixed_thead = TRUE)
...
```{r Styling Data SetA, echo=FALSE}
#NOT TO BE USED AS SOLUTION
df_tmp <- df_9

names(df_tmp)[5] <- cell_spec(names(df_tmp)[5], color = "#FE9A2E")

df_tmp%>%
kable(escape = FALSE)%>%
kable_styling(position = "center", full_width = FALSE,  bootstrap_options = c("striped", "hover"))%>%

column_spec(5, bold = TRUE, color = "#000000", background = "#F6E3CE")%>%
scroll_box(height = "350px", width = "NULL", extra_css = NULL, fixed_thead = TRUE)
...
```{r Styling Data SetB, echo=FALSE}
#NOT TO BE USED AS SOLUTION
df_tmp <- df_10
...
read.bibtex(file = "./citations/netflix_titles.bib")
...
keywords <- 'Netflix TV movies'
commands <- 'stri_trans_nfd str_detect str_sub str_replace_all str_split str_to_upper str_to_lower str_to_sentence str_to_title'
sources <- 'FLIXABLE'
