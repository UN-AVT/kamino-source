...
```{r, out.width="60%", fig.align="center", fig.cap="Photo by Leon on Unsplash"}

masthead <- "assets/leon-MUZFKa_mttU-unsplash.jpg"
...
read.bibtex(file = "./citations/hourly-earnings-male-vs-female.bib")
...
keywords <- 'earnings salary employee'
commands <- 'format f2si'
sources <- 'ILOSTAT'
